...
export default function PlayerFieldZone(props) {
  ...
  drawHand()
    ...
    <div className={playerClass}>
      <div className="phase_display"><button onClick={()=>dispatch({ type: "DECREMENT_PHASE"})} >Decrement Phase</button><button onClick={()=>dispatch({ type: "INCREMENT_PHASE_2"})} >Increment Phase</button>{phaseTester2}</div>
